...
const qa: { q: string; a: string }[] = [
  {
    q: "第一次來，會發生什麼？",
    a: `先坐下來說說話。聊聊你為什麼來、身體最近有什麼訊號、你自己觀察到了什麼。
...
方法上長期投入 Be Activated、Body-Mind Centering、Somatic Experiencing、Applied Kinesiology、Internal Family System、Feldenkrais 等身心整合系統。
